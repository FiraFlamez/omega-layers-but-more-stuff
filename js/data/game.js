const game = {
    ...
    achievements: [
        ...
        new Achievement("Aleph-4", "Have 4.44e444 aleph", "&aleph;<sub>4</sub>", () => game.alephLayer.aleph.gte("4.44e444")),
        new Achievement("Aleph-Infinity", "Have around F10 aleph", "&aleph;<sub>∞</sub>", () => game.alephLayer.aleph.gte("(e^10)2")),
        ...
        new Achievement("Endgame", "Reach layer 2<sup>1024</sup> and finish "+mod.primaryName+mod.secondaryName, "Ʊ", () => game.metaLayer.layer.gte(mod.Infinities[0])),
    ],
    secretAchievements: [
        new Achievement("A very long wait...", "Have a game with over 3 months of time", "...", () => game.timeSpent > 50803200),
        new Achievement("This is stupid.", "Have a game with over 30 months of time", "...", () => game.timeSpent > 508032000),
        new Achievement("Aleph-π", "Have πe592 aleph", "&aleph;<sub>π</sub>", () => game.alephLayer.aleph.gte("3.141e592")),
        new Achievement("Aleph-2<sup>2048</sup>", "Have around F16 aleph", "&aleph;<sub>2<sup>2048</sup></sub>", () => game.alephLayer.aleph.gte("(e^16)2")),
        ...
        new Achievement("Now you are just spamming the \"+\"...", "Get &Omega<sup>&Omega</sup>; without meta", "!&Mu;&epsilon&tau;&alpha;", () => game.highestLayer >= 95 && !game.metaLayer.active),
        ...
        new Achievement("Volatility sucks<sup>a<sup>lot</sup></sup>.", "Get &Omega<sup>&alpha</sup>; without layer volatility upgrade", "!V&sigma;l&alpha;&tau;&iota;&lambda;&iota;&tau;&gamma;", () => game.highestLayer >= 48 && game.volatility.layerVolatility.level.eq(0)),
    ],
